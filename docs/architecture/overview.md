...
- GitHub Actions CI at `.github/workflows/ci.yml` runs backend unit tests,
  ...
  to `main` and every PR. `deploy.yml` is a scaffold (commented jobs).
...
- `docs/` — this directory. Product design docs at `docs/product/`;
  architecture, deploy, dev, API docs under their respective subtrees.
