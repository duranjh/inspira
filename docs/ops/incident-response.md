...
**Audience:** the operator on duty (currently: the founder, solo).
...
- Primary contact: founder's mobile phone + email alias `on-call@tryinspira.com` *(alias to be configured)*
