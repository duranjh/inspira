"""Tests for the Wave I (2026-05-12) monthly/annual billing period plumbing.
...
calls. End-to-end Stripe Test-mode validation happens during the founder
ops setup (see ``docs/ops/`` or the master plan's Wave I day-by-day).
"""
...
def test_annual_requested_but_not_configured_raises(monkeypatch):
    ...
    the founder configures the missing env var.
    """
    provider = _provider(
        monthly={"pro": "price_pro_monthly"},
