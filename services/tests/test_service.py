...
class PlanningStudioServiceTests(unittest.TestCase):
    ...
    def test_seed_data_exists(self) -> None:
        ...
        self.assertEqual(status, 200)
        self.assertEqual(payload["projects"][0]["project_id"], "project-demo-bootstrap")

        status, sessions = self.app.handle_sessions(None, {"project_id": ["project-demo-bootstrap"]})  # type: ignore[arg-type]
        self.assertEqual(status, 200)
    ...
    def test_create_session_supports_save_and_resume(self) -> None:
        request_body = json.dumps(
            {
                "project_id": "project-demo-bootstrap",
...
class PlanningStudioV2SchemaTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.project_id = "project-demo-bootstrap"
