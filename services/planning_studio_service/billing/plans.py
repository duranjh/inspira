...
- Marketing + pricing page copy lives next door in
  ``docs/marketing/pricing-page-copy.md`` and needs to stay in lock-step —
...
class Limits:
    ...
    # that match the marketing copy in pricing-page-copy.md.
...
PLANS: list[Plan] = [
    ...
    Plan(
        ...
        # price) flips to the Frontier rebrand 2026-04-28.
        slug="team",
        title="Frontier",
        monthly_price_cents=20000,  # $200/month — head-to-head with ChatGPT Pro / Claude Max top tier
