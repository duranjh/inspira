...
``feedback_provider_rule_claude_codegen_only``), sub-agent
extraction is non-code-gen so always uses OpenAI regardless of
tier.
...
def _build_user_prompt(
    *,
    ...
    ``correction_note`` (founder direction 2026-05-05): when a partner
