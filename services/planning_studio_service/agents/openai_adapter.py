...
# Pinned model for theme extraction (YC v4 — B3 paste-feedback flow).
...
# and the v4 demo depends on this surface working.
...
class OpenAIConfig:
    ...
    # 45s timeout — bumped from 15s on 2026-05-01 to accommodate B1
    ...
    # progressive heartbeats keep the demo alive throughout.
...
class OpenAIPlanningInterviewer(PlanningInterviewer):
    ...
    def __init__(
        ...
        if client is None:
            ...
            # (live observation 2026-04-30 deploy 395583f: a single call
            # ran >180s of httpx timeouts before the first transient_caught
            # warning fired). We own the retry policy; the SDK should not.
    ...
    def topic_turn(
        ...
        *,
        ...
        # ``tiers.tier_to_timeout_s`` for the founder-locked per-tier
    ...
    def extract_themes(
        ...
        *,
        ...
        """Cluster pasted customer feedback into 3-5 themes (YC v4).
        ...
        this is a cheap clustering job (~$0.001/call) and the v4 demo
        depends on the surface working for every user including Free.
    ...
    # by founder lock-in (mirror #092 OpenAI-only pattern). Each public
