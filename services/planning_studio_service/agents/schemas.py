...
The prompt definitions in ``prompts.py`` are the source of truth; keep this
        ...
        "topics": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    # B1 (v4) — pre-populated Q&A per topic. The
...
# (v4 — B3 paste-feedback flow. Each theme becomes one auto-generated
...
TOOL_SPECS: dict[str, dict] = {
    ...
    "extract_themes_response": {
        ...
        "description": (
            ...
            "the workspace home (v4 paste-feedback flow). Cheap "
