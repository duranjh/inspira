"""W2-θ comment cascade — regenerates decisions in response to a user comment.
...
Provider rule (per founder lock-in 2026-05-03): cascade is NOT code-gen,
so it dispatches to **gpt-5-mini** (matches F4/F5/F6 conventions, NOT
gpt-4o-mini — see PR #19 on main).
...
def compute_affected_scope(
    ...
    *,
    ...
    Banner thresholds (matching B3.2 design + user lock-in 2026-05-03):
