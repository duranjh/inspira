"""FastAPI router for the W2 exports surface.
...
def make_exports_router(
    ...
    async def pr_verification_route(
        ...
        Product decision: once the PR is actually in GitHub, Inspira
        verifies the change actually landed and is working as
        expected. v0 reports what the repo's existing
