"""Issue-body composition for the W2 export surface.
...
shape mirrors the Decision Summary preview in the internal v12
hi-fi (design files not included in this repo):
