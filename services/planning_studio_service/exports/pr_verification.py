...
Product decision: once a PR is actually in GitHub, Inspira re-checks
it to verify the change actually landed and is working as expected.
...
what the repo's existing CI says.
