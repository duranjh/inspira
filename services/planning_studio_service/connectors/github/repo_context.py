...
Founder direction (2026-05-04): "Inspira should consistently every
single before it starts a canvas, should pull the latest repo from
GitHub" — i.e. don't generate against a stale snapshot, always
read fresh.
