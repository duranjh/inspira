...
INTERCOM = ConnectorDescriptor(
    ...
    contact_route="mailto:hello@tryinspira.com?subject=Intercom%20connector",
)
...
PRODUCTBOARD = ConnectorDescriptor(
    ...
    contact_route="mailto:hello@tryinspira.com?subject=Productboard%20connector",
)
...
SALESFORCE = ConnectorDescriptor(
    ...
    contact_route="mailto:hello@tryinspira.com?subject=Salesforce%20connector",
)
...
HELPSCOUT = ConnectorDescriptor(
    ...
    contact_route="mailto:hello@tryinspira.com?subject=Help%20Scout%20connector",
)
