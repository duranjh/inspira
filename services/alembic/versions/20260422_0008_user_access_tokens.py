...
``down_revision = "20260422_0006"``. The BYOK migration slot
(``20260422_0007``) has not landed in this worktree yet — the parent
session will re-sequence if both PAT and BYOK merge on top of 0006.
"""
