...
the voice feature was retired entirely.

Tables dropped
--------------

Credit ledger (packs never charged real money via the Noop billing
provider, so the rows are best-effort ledger entries that no one
