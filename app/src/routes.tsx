...
// /workspaces (product decision; see #121).
//
...
export function AppRoutes() {
  return (
    <>
      ...
      <CookieBanner />
      {/* B2.3 — listens globally for `inspira:promote-to-project`
