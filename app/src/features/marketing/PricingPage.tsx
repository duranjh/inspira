...
//
// Render mirrors the internal v5-pivot hi-fi (design files not included
// in this repo). Tier copy
...
export function PricingPage() {
  ...
  // Defaults to annual. Toggle persists for the session only —
  // no localStorage, so a refresh intentionally resets to annual.
