...
//
//   STUBS — backend routes still on the handoff doc. Each returns a
...
//
// See docs/product/billing-frontend-handoff.md for the authoritative
// endpoint list + shapes the backend team is implementing against.
...
export const billingApi = {
  ...
  startCheckout: (input: {
    ...
    bpostJson("/api/v2/billing/checkout", {
      ...
      // client change. See billing-frontend-handoff.md.
      period: input.period,
      seats: input.seats,
    }),
