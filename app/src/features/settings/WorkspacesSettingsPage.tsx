...
// type-"delete"-to-confirm modal (founder direction 2026-05-05:
// "very careful, tedious confirmation"); BE soft-deletes by setting
...
/**
 * Type-"delete"-to-confirm modal. Founder direction 2026-05-05:
 * "very careful, tedious confirmation. Type the word delete to
 * confirm and then press continue."
 *
