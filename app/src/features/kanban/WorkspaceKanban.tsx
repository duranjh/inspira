...
/** Static column metadata — copy ported from the internal v12 hi-fi
 * (design files not included in this repo), rebound to the v4 state
 * machine mapping in useKanbanData.columnFor. The order is the visual
 * left-to-right order. */
...
export function WorkspaceKanban(props: WorkspaceKanbanProps) {
  ...
  // Autonomous flow (product decision): Inspira should
  ...
  function onDragEnd(event: DragEndEvent) {
    ...
    // Product decision: the override dialog ONLY fires
