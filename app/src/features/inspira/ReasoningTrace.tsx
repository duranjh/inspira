// Collapsed-by-default reasoning expander inside Topic Detail.
//
// Four sections per the internal v12 hi-fi (design files not included
// in this repo):
...
//   4. Re-think this topic         — disabled button (enabled once the
//                                    regenerate-cascade endpoint ships)
//
...
// follow-up that adds the remaining strings to en.json.
    ...
    <section className="topic-detail__reasoning">
      ...
      {isOpen && (
        ...
        >
          ...
          {/* 4. Re-think — disabled until regenerate-cascade ships */}
          <section className="topic-detail__reasoning-section">
            <button
              type="button"
