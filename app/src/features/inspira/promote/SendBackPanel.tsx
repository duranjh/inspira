// Send-back-to-AI inline panel inside the Promote dialog.
//
...
// backend redraft endpoint that doesn't exist yet — wiring it
// optimistically with a fake "sent to AI" toast would overstate what
// the AI actually did. When the redraft endpoint ships, drop the
// disabled flag and dispatch the instructions.
