...
// B1.2 / W3 δ — per-decision provenance for canvas-review badges. Origin
...
// W2 η — flat row returned by GET /projects/{id}/topics/{topic_id}/provenance.
...
// Internal — exported so the W2-θ comments module's standalone fetch
...
// the pattern already used by updateProfile / changePassword. See
// docs/product/inapp-frontend-handoff.md for the full handoff shape.
...
export const api = {
  ...
  // YC v4 — extract themes from pasted customer feedback. The
  ...
  // B2.3 / W3 δ — promote a feedback cluster into a new project. Stub:
  ...
  // (B3 / #077) — `updateTopicPrivateNotes` removed when the founder
  // asked us to drop the Private Notes panel from the topic-detail
  // drawer. Backend route + `private_notes` column are preserved so
   ...
   *
   * Founder direction (2026-05-04): once the PR is in GitHub, Inspira
