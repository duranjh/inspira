// Pulse next to the Topic Detail header title when a sub-agent
...
// The existing `MultiAgentDots` filters by topic_id and never matches
...
// Strings inlined intentionally — this ships before the en→{de,es,fr,it,
