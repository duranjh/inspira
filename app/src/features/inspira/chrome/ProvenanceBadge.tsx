// B1.2 / W3 δ — per-decision provenance badge.
//
...
export function ProvenanceBadge({ decision }: ProvenanceBadgeProps) {
  ...
  // User-typed decisions don't render a badge at all — preserves the
  // capability-vs-usage rule (no AI claim where there's no AI authorship).
