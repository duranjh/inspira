...
Output: docs/qa/mock-feedback-5k.csv (gitignored — regenerable from
...
Usage:
    ...
    # → docs/qa/mock-feedback-5k.csv  (write, ~600KB)
"""
...
SEED = 42
TOTAL_ROWS = 5000
OUTPUT = Path(__file__).resolve().parent.parent / "docs" / "qa" / "mock-feedback-5k.csv"
