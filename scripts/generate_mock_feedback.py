...
Output: local/mock-feedback-200.csv
...
fixtures must never imply real customers or real usage.
"""
...
OUT_PATH = Path(__file__).resolve().parent.parent / "local" / "mock-feedback-200.csv"
